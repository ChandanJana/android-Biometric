...
public final class FragmentBiometricBinding implements ViewBinding {
  ...
  private FragmentBiometricBinding(@NonNull ConstraintLayout rootView,
  ...
  public static FragmentBiometricBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_biometric, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentBiometricBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentBiometricBinding((ConstraintLayout) rootView, textDashboard);
    }
